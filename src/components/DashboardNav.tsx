...
import { LayoutDashboard, User, MessageCircle, FileText, Search, LogOut, CalendarDays, Building2, Menu, X, Send, ClipboardList } from "lucide-react";
...
const rehberLinks = [
  ...
  { href: "/dashboard/rehber/ilanlar", label: "İlanlar", icon: Search },
  { href: "/dashboard/rehber/basvurularim", label: "Başvurularım", icon: Send },
];
...
const acenteLinks = [
  ...
  { href: "/dashboard/acente/basvurular", label: "Başvurular", icon: ClipboardList },
